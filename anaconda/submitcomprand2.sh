...
python comprand.py  --learning_rate 2.5e-3 --seed 2 --env-id entombed_competitive_v3 --total-timesteps 7500000 --track --wandb-project-name cleanrldas --capture_video
