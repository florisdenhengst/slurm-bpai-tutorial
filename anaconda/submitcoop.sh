...
conda init
conda activate bpai
python coopclean.py  --env-id entombed_cooperative_v4 --total-timesteps 500000 

#python dqnslurm.py --seed $SLURM_ARRAY_TASK_ID --env-id pistonball_v6 --total-timesteps 500000 --track --wandb-project-name cleanrldas --capture_video
