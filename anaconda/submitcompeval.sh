...
python evalcomp.py --learning_rate 2.5e-3 --env-id entombed_competitive_v3 --total-timesteps 50000 --save_path entombed_competitive_v3__comprand__2__1719257787 --track --wandb-project-name cleanrldas --capture_video 
